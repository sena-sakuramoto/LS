...
export default function Careers() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="container max-w-7xl">
          ...
          <div className="space-y-10 md:space-y-12">
            {[
              ...
              <div 
                key={index}
                className={`group relative p-10 md:p-12 border-2 border-gray-200 hover:border-[#d4af37] transition-all duration-700 hover:shadow-2xl ${isVisible.phase ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}`}
              ...
              >
                ...
                <div className="flex flex-col md:flex-row gap-12 items-start">
                  <div className="flex-shrink-0">
                    <div className="text-4xl md:text-5xl font-light text-gray-100 group-hover:gold-gradient transition-all duration-700">
      ...
      <section 
        id="culture"
        className={`relative py-20 md:py-32 lg:py-40 bg-gradient-to-b from-gray-900 to-black text-white transition-all duration-1000 ${isVisible.culture ? 'opacity-100' : 'opacity-0'}`}
      >
        <div className="container max-w-7xl">
          <div className="text-center mb-16 md:mb-24">
            <div className="flex items-center justify-center gap-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {[
              ...
              <div 
                key={index}
                className={`group flex items-start gap-6 p-8 md:p-10 bg-white/5 border border-white/10 hover:border-[#d4af37] transition-all duration-700 hover:bg-white/10 cursor-pointer ${isVisible.culture ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
                style={{ transitionDelay: `${index * 0.1}s` }}
              >
      ...
      <section 
        id="positions"
        className={`relative py-20 md:py-32 lg:py-40 bg-white text-black transition-all duration-1000 ${isVisible.positions ? 'opacity-100' : 'opacity-0'}`}
      >
        <div className="container max-w-7xl">
          <div className="text-center mb-16 md:mb-24">
            <div className="flex items-center justify-center gap-6 mb-8">
          ...
          <div className="space-y-12 md:space-y-16">
            ...
            <div 
              className={`group relative p-10 sm:p-12 md:p-16 bg-gradient-to-br from-gray-50 via-white to-gray-50 border-2 border-gray-200 hover:border-[#d4af37] transition-all duration-1000 hover:shadow-2xl ${isVisible.positions ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}
            >
              ...
              <div className="space-y-8 md:space-y-10">
                ...
                <div className="space-y-8 md:space-y-10">
                  <div>
                    ...
                    <ul className="space-y-3 text-base text-gray-600 font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16 mb-16 md:mb-20">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <a href="https://herp.careers/v1/lscompany" target="_blank" rel="noopener noreferrer" className="block text-gray-400 hover:text-[#d4af37] transition-colors text-sm md:text-base font-light">
                  採用ページ
                </a>
              </div>
            </div>
