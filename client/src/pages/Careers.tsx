            ...
            {[
              {
                ...
                role: "プロジェクトマネージャー",
                years: "2023年入社 / 20代",
                previousJob: "不動産業界での営業経験を経てLSへ",
                quote: "大型案件を任せてもらえる。やりたいことに挑戦できる環境",
                interview: "前職では営業として働いていましたが、もっと経営視点で事業に関わりたいと思っていました。LSでは入社してすぐに1000万円規模の案件を担当させてもらい、経営陣と直接議論しながらプロジェクトを進められる。成長スピードが全然違います。",
                imageGradient: "from-gray-600 to-gray-800",
                highlights: [
                  "入社1年で大型案件のPMを経験",
                  "経営陣との距離が近く、フィードバックが早い",
                  "実力評価で年収もアップ"
                ],
                skills: [
                  { skill: "営業スキル", before: 65, after: 88 },
                  { skill: "PM管理", before: 40, after: 82 },
                  { skill: "経営視点", before: 30, after: 78 },
                  { skill: "提案力", before: 60, after: 90 }
                ]
              },
              {
                name: "M.T.",
                role: "デザイナー",
                years: "2023年入社 / 20代",
                previousJob: "設計事務所での実務経験あり",
                quote: "ブランドコンセプトから関われる。デザインの幅が広がった",
                interview: "前職は指示通りに図面を描く仕事でしたが、LSではクライアントのブランド戦略から一緒に考えます。デザインの自由度も高いですし、自分の提案が採用されることも多い。ハイブランドの案件に関われるのもやりがいです。",
                ...
                skills: [
                  { skill: "設計スキル", before: 70, after: 90 },
                  { skill: "3Dモデリング", before: 50, after: 85 },
                  { skill: "ブランド理解", before: 45, after: 83 },
                  { skill: "プレゼン", before: 55, after: 85 }
                ]
              },
              {
                name: "D.Y.",
                role: "施工管理",
                years: "2022年入社 / 30代",
                previousJob: "建設会社での施工管理経験を活かす",
                quote: "提案が形になる。経営陣が現場の声を聞いてくれる",
                interview: "大手では決められた現場を管理するだけでしたが、LSでは施工プロセスの改善や原価管理まで任せてもらえます。自分の提案が会社の仕組みに反映されるのが嬉しい。現場の声が経営に届く環境です。",
                ...
                skills: [
                  { skill: "施工管理", before: 75, after: 92 },
                  { skill: "原価管理", before: 60, after: 88 },
                  { skill: "交渉力", before: 50, after: 85 },
                  { skill: "マネジメント", before: 40, after: 80 }
                ]
              },
              {
                name: "S.K.",
                role: "営業リーダー",
                years: "創業メンバー / 30代",
                previousJob: "ベンチャー企業での営業マネージャー経験",
                quote: "少数精鋭だから、一人ひとりの影響力が大きい",
                interview: "創業期から関わっていますが、会社の成長と自分の成長がリンクしている実感があります。事業戦略、組織づくり、採用まで関われるのはベンチャーならでは。挑戦を楽しめる人には最高の環境だと思います。",
                ...
                skills: [
                  { skill: "事業戦略", before: 65, after: 93 },
                  { skill: "組織構築", before: 55, after: 88 },
                  { skill: "採用", before: 60, after: 86 },
                  { skill: "リーダーシップ", before: 70, after: 94 }
                ]
              }
            ].map((interview, index) => (
              <div
